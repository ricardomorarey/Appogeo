...
interface DatosMadridSevice {
    ...
    fun searchEmbajadasConsulados(): Call<List<HistorialEntity>>

    @GET("/201000-0-embajadasconsulados.\n" +
            "json?{latitud}&{longitud}&distancia=1000")
    fun getECLatLong(@Path("latitud") latitud: Long, @Path("longitud") longitud: Long):Call<List<HistorialEntity>>
